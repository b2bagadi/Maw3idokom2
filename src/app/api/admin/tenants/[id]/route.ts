...
export async function DELETE(
  ...
  try {
    ...
    const { appointments, workingHours, reviews, staff, staffServices, services, users } = await import('@/db/schema');
    ...
    // 4. Delete staff services (junction table) for all staff in this tenant
    ...
    // 7. Delete users associated with this tenant
