...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!businessSlug || !serviceId || !startTime) {
    ...
    if (staffId && (isNaN(parsedStaffId!) || parsedStaffId! <= 0)) {
    ...
    const result = await db
      ...
      .values({
        ...
        serviceId: parsedServiceId,  // Use parsed value
        staffId: parsedStaffId,  // Use parsed value
        customerId: body.customerId ? Number(body.customerId) : null,
        guestName: body.customerId ? null : guestName,
        guestEmail: body.customerId ? null : guestEmail,
        guestPhone: body.customerId ? null : guestPhone,
