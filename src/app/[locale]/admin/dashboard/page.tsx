                        ...
                        <div className="flex-1 min-w-[200px]">
                          ...
                          <div className="flex gap-2 mt-4">
                            {appt.guestPhone && (() => {
                              ...
                              // WhatsApp needs format: country code + number (no + symbol, no spaces)
                              const formatPhoneForWhatsApp = (phone: string) => {
                                // Remove all non-numeric characters except +
                                let cleaned = phone.replace(/[^\d+]/g, '');
                                // Remove + if present (WhatsApp doesn't need it in URL)
                                cleaned = cleaned.replace(/^\+/, '');
                                return cleaned;
                              };

                              const whatsappNumber = formatPhoneForWhatsApp(appt.guestPhone);
