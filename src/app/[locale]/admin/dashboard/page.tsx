...
type Section = 'businesses' | 'services' | 'staff' | 'appointments' | 'contacts' | 'i18n' | 'settings' | 'password' | 'customers' | 'reviews';
...
export default function AdminDashboardPage() {
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      ...
      case 'appointments':
        return <AppointmentsView onAction={handleAppointmentAction} />;
