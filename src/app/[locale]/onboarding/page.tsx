    ...
    try {
      ...
      if (response.ok) {
        ...
        if (notificationMethod === 'whatsapp') {
          ...
          const name = selectedAppointment.guestName || 'Guest';
          const message = encodeURIComponent(
            `Hello ${name}, we regret to inform you that your appointment has been rejected. Reason: ${rejectionReason}`
          );
          window.open(`https://wa.me/${phone}?text=${message}`, '_blank');
        }
              ...
              <div className="flex justify-between items-start flex-wrap gap-4">
                <div className="flex-1 min-w-[200px]">
                  ...
                  <CardDescription className="mt-2 space-y-1">
                    ...
                    <div>⏱️ {appointment.service?.duration} minutes • MAD {appointment.service?.price}</div>
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-background to-muted/20">
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setRejectDialogOpen(false)}>Back</Button>
