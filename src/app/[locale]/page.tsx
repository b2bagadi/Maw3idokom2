    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 relative overflow-hidden">
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-start pt-6 animate-[fade-in_1s_ease-out_0.6s_backwards]">
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              ...
              <Link
                href="/business/login"
                className="inline-flex items-center justify-center w-full md:w-auto text-base px-8 py-3 font-medium rounded-lg bg-white/10 hover:bg-white/20 text-foreground border border-border/50 hover:border-primary/50 transition-all duration-300"
              >
                {t('businessLogin')}
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <Link
                href="/book?slug=demo"
                className="inline-flex items-center justify-center w-full md:w-auto text-lg px-12 py-7 font-bold rounded-lg bg-gradient-to-r from-[oklch(0.55_0.15_145)] to-[oklch(0.70_0.12_75)] text-white hover:shadow-2xl hover:opacity-90 transition-all duration-300 cursor-pointer group relative z-10"
                style={{ pointerEvents: 'auto' }}
              >
