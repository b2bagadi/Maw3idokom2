        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-12 justify-center items-start pt-10 animate-[fade-in_1s_ease-out_0.6s_backwards]">
            ...
            <div className="flex flex-col gap-6 w-full md:w-auto items-center">
              ...
              <Link
                href="/business/login"
                className="inline-flex items-center justify-center w-full md:w-64 text-base px-8 py-4 font-bold rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 text-foreground border border-white/20 hover:border-primary/50 transition-all duration-300 shadow-lg hover:shadow-primary/20 group relative z-10"
                style={{ pointerEvents: 'auto' }}
              >
                <span className="group-hover:text-primary transition-colors duration-300">{t('businessLogin')}</span>
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-6 w-full md:w-auto items-center">
              <Link
                href="/book?slug=demo"
                className="inline-flex items-center justify-center w-full md:w-auto text-lg px-12 py-7 font-bold rounded-lg bg-gradient-to-r from-[oklch(0.55_0.15_145)] to-[oklch(0.70_0.12_75)] text-white hover:shadow-2xl hover:opacity-90 transition-all duration-300 cursor-pointer group relative z-10 hover:scale-105"
                style={{ pointerEvents: 'auto' }}
              >
              ...
              <Link
                ...
                style={{ pointerEvents: 'auto' }}
              >
                <span className="group-hover:text-primary transition-colors duration-300">{t('clientLogin')}</span>
              </Link>
            </div>
