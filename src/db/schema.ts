...
export const globalSettings = sqliteTable('global_settings', {
  ...
  autoReplyTemplateEn: text('auto_reply_template_en'),
  autoReplyTemplateFr: text('auto_reply_template_fr'),
  autoReplyTemplateAr: text('auto_reply_template_ar'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
});

// Categories model - for business categorization
...
export const contactRequests = sqliteTable('contact_requests', {
  ...
  preferredContact: text('preferred_contact').notNull(), // email, whatsapp
  ...
  createdAtIndex: index('contact_request_created_at_idx').on(table.createdAt),
}));

// Reviews model - customer ratings and comments for businesses
