                        ...
                        {isLoading ? (
                            ...
                            appointments.map((appointment) => (
                                <TableRow key={appointment.id} data-state={selectedIds.includes(appointment.id) && "selected"}>
                                    ...
                                    {scope === 'admin' && (
                                        <TableCell>
                                            <div className="font-medium">{appointment.businessName || appointment.tenantId}</div>
                                            <div className="text-xs text-muted-foreground">ID: {appointment.tenantId}</div>
                                        </TableCell>
                                    )}
                                    <TableCell>
                                        ...
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuSeparator />
                                                    <DropdownMenuItem
                                                        onClick={() => onAction && onAction('delete', appointment)}
                                                        className="text-red-600 focus:text-red-600 focus:bg-red-50"
                                                    >
                                                        <X className="mr-2 h-4 w-4" />
                                                        {t('delete', { defaultMessage: "Delete" })}
                                                    </DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
                                        </div>
